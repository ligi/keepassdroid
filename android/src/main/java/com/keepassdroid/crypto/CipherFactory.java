...
public class CipherFactory {
    public static final UUID AES_CIPHER = Types.bytestoUUID(new byte[]{(byte) 0x31,
                                                                       (byte) 0xC1,
                                                                       (byte) 0xF2,
                                                                       (byte) 0xE6,
                                                                       (byte) 0xBF,
                                                                       ...
                                                                       0x5A,
                                                                       (byte) 0xFF});
    public static final UUID TWOFISH_CIPHER = Types.bytestoUUID(new byte[]{(byte) 0xAD,
                                                                           (byte) 0x68,
                                                                           (byte) 0xF2,
                                                                           (byte) 0x9F,
                                                                           (byte) 0x57,
     ...
     */
    public static Cipher getInstance(UUID uuid,
                                     int opmode,
                                     byte[] key,
    ...
    public static Cipher getInstance(UUID uuid,
                                     ...
                                     byte[] key,
                                     byte[] IV,
                                     boolean androidOverride) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException {
